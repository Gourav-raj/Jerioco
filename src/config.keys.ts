const REACT_APP_CLIENT_URL = "https://localhost:3000"
const REACT_APP_SERVER_URL = "https://localhost:5000"
const REACT_APP_CONVERGENCE_URL = "https://localhost:8080" 
...
export const CONVERGENCE_URL = process.env.REACT_APP_CONVERGENCE_URL!;
